...
const text2 = `Nasway | 15 лет

Всё началось с Python. Где-то в сентябре 2024 я просто решил попробовать программировать. Нашел курс на ютубе, начал смотреть. Python показался простым, я быстро втянулся. Написал пару программок: угадай число, калькулятор, потом какой-то простенький парсер. Но чем дальше, тем больше понимал: Python тормозной. Для серьезных вещей, где нужна производительность, он не очень. На нем крутого софта не напишешь, только скрипты для себя. И я задумался: а что дальше?

Решил, что хочу написать свое приложение. Под ПК и под Android, чтобы синхронизация была. Выбор пал на Java. Заказал книгу Васильева Алексея Николаевича. Думал, если куплю книгу, она меня всему научит. Ну, знаете, как многие думают: куплю самоучитель и стану программистом. Книга дала фундамент, да. Основы, синтаксис, ООП. Но реально понять, как писать код, я смог только когда сам начал что-то делать. Тогда я начинал несколько проектов, но забрасывал. Не хватало понимания, как всё собрать воедино.

Потом подумал: а не попробовать ли себя в читах для игр? Плюс мысль была подзаработать немного. Взялся за C++. И снова заказал книгу Васильева — теперь по плюсам. Зачем? Сам не знаю. Думал, вот сейчас прочту и сразу смогу читы писать. Наивный был. Книга — это просто буквы. Она дает понимание, как язык устроен, но не учит применять это в реальных задачах. Летом у меня было свободное время, учеба закончилась. Я реально вгрызся в C++. Прочитал книгу, начал смотреть курсы на ютубе. Писал свои маленькие программы, разбирался с памятью, с указателями. Потом решил написать чит для Minecraft. Использовал чужие исходники как основу, но логику писал сам. Закончил проект. Чит получился багованный, многое не работало как надо, но я его допилил до состояния "работает". Пользовался им какое-то время, потом забросил.

А потом вернулся к Java. Понял, что хочу сделать что-то большое и интересное. Начал изучать Minecraft Coder Pack (MCP) и решил переписать Minecraft под себя — создать свой проект на основе Java, который объединит механики Rust и Minecraft. Так родился CoilRust.

Кратко по языкам

Java
Уровень где-то между Junior и Middle. Сейчас активно пишу на MCP для CoilRust. Хорошо выучил язык именно через этот проект — когда разбираешь код Minecraft, реально прокачиваешься.
"Книга Васильева дала фундамент, но настоящий прорыв случился, когда я начал ковырять Minecraft и переписывать его под себя"

C++
Начал учить летом 2024. Хотел заработать денег на читах для игр. Сейчас иногда возвращаюсь, пишу эксперименты с OpenGL, хуками, памятью. Но основной фокус — на Java.
"Думал, куплю книгу и сразу всё буду уметь. Оказалось, книги не учат думать — учат форумы, исходники и часы дебага"

Python
Самый первый язык, сентябрь 2024. Сейчас использую только для мелких скриптов автоматизации, когда нужно быстро что-то набросать.
"Python — классный для старта, но быстро упираешься в потолок. Для взрослых задач берешь C++ или Java"

Статистика проектов

В процессе: 2 (CoilRust на Java/MCP и чит на C++ для изучения OpenGL)
В глубокой заморозке: 1 (тот самый Telegram-бот на Python)
Завершено: 4 (консольные игры, мелкие скрипты, первый чит для Minecraft)
Неосуществлённых идей: 2 (лежат в голове, когда-нибудь дойдут руки)

Планы на будущее

Хочу изучить Rust. Интересно попробовать что-то новое, да и в игровых проектах он может пригодиться.

"Код не прощает глупости, но позволяет учиться на ней"
"Лучший способ научиться программировать — писать код и гуглить ошибки"
"Если не лажал — ты не программист. Лажал, чинил, снова лажал — вот это путь"`;
